                ...
                <div class="col-12">           
                    <div class="card">
                        <div class="card-header">
                            <h3 class="card-title"><strong>Daftar Kontrak</strong></h3>
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td style="text-align: left">
                                            <a target="_blank" href="{{ route('contracts.print', ['id' => $item->id]) }}" class="btn btn-success btn-sm" data-toggle="tooltip" title="Cetak" style="width:30px">
                                                <span class="fas fa-print"></span>
                                            </a>   
                                            <a href="{{ route('contracts.delete', ['id' => $item->id]) }}" class="btn btn-danger btn-sm" data-toggle="tooltip" title="Hapus" style="width:30px">
