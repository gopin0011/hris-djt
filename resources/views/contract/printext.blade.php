@if($detail->durasi != 'TLH' && $detail->durasi != 'Tetap')
    <html lang="en">
        <head>
            <meta charset="UTF-8">
            <meta name="viewport" content="width=device-width, initial-scale=1.0">
            <meta http-equiv="X-UA-Compatible" content="ie=edge">
            <title>Kontrak Pegawai - {{ Crypt::decryptString($detail->nama) }}</title>
                    ...
                    <tr>
                        ...
                        <td style="text-align: left">
                            <p style="text-align: justify">
                                @if($detail->durasi == 'Tetap')
                                    Menerima permohonan kerja Saudara {{ Crypt::decryptString($detail->nama) }} sebagai karyawan tetap di PT. Dwida Jaya Tama.                       
                                @else
                    ...
                    <tr>
                        ...
                        <td style="text-align: left">
                            <table>
                                ...
                                <tr>
                                    <td style="text-align: left;vertical-align: text-top">Tanggal</td>
            ...
            <table>
                <tbody>
                    ...
                    <tr>
                        ...
                        <td style="width:10px;vertical-align: text-top">:</td>
                        <td style="text-align: left">
                            <strong>{{ Crypt::decryptString($item->gender) }}</strong>
                        </td>
                    </tr>
                    <tr>
                        <td style="text-align: left;"></td>
                        ...
                        <td style="width:10px;vertical-align: text-top">:</td>
                        <td style="text-align: left">
                            <strong>{{ Crypt::decryptString($item->tmlahir) }}</strong>
                        </td>
                    </tr>
                    <tr>
                        <td style="text-align: left"></td>
                        ...
                        <td style="width:10px;vertical-align: text-top">:</td>
                        <td style="text-align: left">
                            <strong>{{ Crypt::decryptString($item->hlahir) }} {{ Crypt::decryptString($item->blahir) }} {{ Crypt::decryptString($item->thahir) }}</strong>
                        </td>
                    </tr>
                    <tr>
                        <td style="text-align: left"></td>
                        ...
                        <td style="width:10px;vertical-align: text-top">:</td>
                        <td style="text-align: left">
                            <strong>{{ Crypt::decryptString($item->alamat) }}</strong>
                        </td>
                    </tr>
                    <tr>
                        <td style="text-align: left"></td>
            ...
            <table>
                <tbody>
                    <tr>
                        <td style="vertical-align: text-top">
                            <p style="text-align: left">
                                Demikian Perjanjian Kerja ini dibuat dalam 2 (dua) rangkap dan ditandatangani oleh kedua belah pihak. Masing-masing pihak akan memperoleh salah satu rangkap diantaranya termasuk kantor tempat bekerja, dan masing-masing rangkap mempunyai kekuatan hukum yang sama.
                            </p>
                        </td>
                    </tr>
                </tbody>
            ...
            <table>
                <tbody>
                    ...
                    <tr>
                        ...
                        <td style="text-align: left;"><strong>Alamat</strong></td>
                        <td style="width:10px;vertical-align: text-top">:</td>
                        <td style="text-align: left"><strong>{{ Crypt::decryptString($item->alamat) }}</strong></td>
                    </tr>
...
@elseif($detail->durasi == 'Tetap') <!-- ganti isi -->
    <html lang="en">
        <head>
            <meta charset="UTF-8">
            <meta name="viewport" content="width=device-width, initial-scale=1.0">
        ...
        <!-- HALAMAN 1 /////////////////////////////////////////////////////////////// -->
            <table style="margin-top:30px">
                <tbody>
                    <tr>
                        <td><strong><u>SURAT KEPUTUSAN DIREKSI</u></strong></td>
                    </tr>
                    <tr>
                        <td style="font-size: 9pt">{{ Crypt::decryptString($detail->nomor) }}</td>
                    </tr>
            ...
            <table style="margin-top:20px">
                <tbody>
                    ...
                    <tr>
                        <td><strong>KENAIKAN GAJI DAN PENGANGKATAN KARYAWAN TETAP</strong></td>
                    </tr>
                    <tr>
                        <td><strong>SDR. {{ strtoupper(Crypt::decryptString($detail->nama)) }}</strong></td>
                    </tr>
                    <tr>
                        <td><strong>DI PT. DWIDA JAYA TAMA</strong></td>
                    </tr>
                </tbody>
            </table>
            ...
            <table style="margin-top:20px">
                <tbody>
                    <tr>
                        <td style="text-align: left;width:100px;vertical-align: text-top"><strong>Menimbang</strong></td>
                        <td style="width:10px;vertical-align: text-top">:</td>
                        <td style="text-align: left">Berdasarkan hasil evaluasi dan penilaian prestasi karyawan serta melihat kinerja saudara yang memuaskan dan dedikasi yang baik di perusahaan ini.</td>
                    </tr>
                    <tr>
                        <td style="text-align: left;width:100px;vertical-align: text-top"><strong>Mengingat</strong></td>
                        <td style="width:10px;vertical-align: text-top">:</td>
                        <td style="text-align: left">
                            1. Peraturan Perusahaan PT. Dwida Jaya Tama.
                        </td>
                    </tr>
                    <tr>
                        <td style="text-align: left;width:100px;vertical-align: text-top"></td>
                        <td style="width:10px;vertical-align: text-top"></td>
                        <td style="text-align: left">
                            2. Struktur Organisasi PT. Dwida Jaya Tama.
                        </td>
                    </tr>
                    <tr>
                        <td style="text-align: left;width:100px;vertical-align: text-top"></td>
                        <td style="width:10px;vertical-align: text-top"></td>
                        <td style="text-align: left">
                            3. Kebijakan Direksi PT. Dwida Jaya Tama.
                        </td>
                    </tr>
                </tbody>
            </table>
            <table style="margin-top:10px">
                <tbody>
                    <tr>
                        <td colspan="3" style="text-align: center"><strong>MEMUTUSKAN</strong></td>
                    </tr>
                </tbody>
            </table>
            <table style="margin-top:10px">
                <tbody>
                    <tr>
                        <td style="text-align: left;width:100px;vertical-align: text-top"><strong>Menetapkan</strong></td>
                        <td style="width:10px;vertical-align: text-top">:</td>
                        <td style="text-align: left">Keputusan Direksi PT. Dwida Jaya Tama tentang perubahan status karyawan Sdr. {{ Crypt::decryptString($detail->nama) }} di PT. Dwida Jaya Tama.</td>
                    </tr>
                    <tr>
                        <td style="text-align: left;width:100px;vertical-align: text-top"><i>Pertama</i></td>
                        <td style="width:10px;vertical-align: text-top">:</td>
                        <td style="text-align: left">Berdasarkan hasil evaluasi dan penilaian prestasi karyawan serta melihat kinerja saudara yang memuaskan dan dedikasi yang baik di perusahaan ini.</td>
                    </tr>
                    <tr>
                        <td style="text-align: left;width:100px;vertical-align: text-top"><i>Kedua</i></td>
                        <td style="width:10px;vertical-align: text-top">:</td>
                        <td style="text-align: left">Mengangkat Sdr. {{ Crypt::decryptString($detail->nama) }} sebagai Karyawan Tetap di PT. Dwida Jaya Tama.</td>
                    </tr>
                    <tr>
                        <td style="text-align: left;width:100px;vertical-align: text-top"><i>Ketiga</i></td>
                        <td style="width:10px;vertical-align: text-top">:</td>
                        <td style="text-align: left">Menetapkan gaji Sdr. {{ Crypt::decryptString($detail->nama) }} menjadi Rp. {{ number_format(Crypt::decryptString($detail->jabatan) + Crypt::decryptString($detail->gapok) + Crypt::decryptString($detail->kinerja) + Crypt::decryptString($detail->pulsa) + Crypt::decryptString($detail->makan) + Crypt::decryptString($detail->transport)) }},-/bulan.</td>
                    </tr>
                    <tr>
                        <td style="text-align: left;width:100px;vertical-align: text-top"><i>Keempat</i></td>
                        <td style="width:10px;vertical-align: text-top">:</td>
                        <td style="text-align: left">Surat keputusan ini efektif sejak tanggal 03 Maret 2020, dengan perincian gaji terlampir.</td>
                    </tr>
                    <tr>
                        <td style="text-align: left;width:100px;vertical-align: text-top"><i>Kelima</i></td>
                        <td style="width:10px;vertical-align: text-top">:</td>
                        <td style="text-align: left">Apabila dikemudian hari Sdr. {{ Crypt::decryptString($detail->nama) }} tidak menunjukkan prestasi sebagaimana mestinya, maka keputusan ini akan ditinjau kembali.</td>
                    </tr>
                </tbody>
            </table>
        ...
        <!-- HALAMAN 2 /////////////////////////////////////////////////////////////// -->
            <table style="margin-top:30px">
                <tbody>
                    <tr>
                        <td><strong>PERINCIAN GAJI</strong></td>
                    </tr>
                </tbody>
            </table>   
                ...
                <tbody>
                    <tr>
                        <table>
                            ...
                            <tr>
                                <td style="text-align: left;width:130px;vertical-align: text-top">NIK</td>
                                <td style="width:5px; text-align:left">:</td>
                                <td colspan="3" style="text-align: left">{{ $item->nik }}</td>
                            </tr>
                            <tr>
                                <td style="text-align: left;vertical-align: text-top">Unit Bisnis</td>
                                <td style="text-align:left">:</td>
                            ...
                            <tr>
                                <td style="text-align: left;vertical-align: text-top">Departemen</td>
                                <td style="text-align:left">:</td>
                                <td colspan="3" style="text-align: left">{{ $item->divisi }}</td>
                            </tr>
                            <tr>
                                <td style="text-align: left;vertical-align: text-top">Jabatan</td>
                                <td style="text-align:left">:</td>
                                <td colspan="3" style="text-align: left">{{ Crypt::decryptString($detail->posisi) }}</td>
                            </tr>
                            @endforeach
            ...
            <table style="margin-top:15px">
                <tbody>
                    <tr>
                        <table style="margin-top:15px">
                            <tr>
                                <td colspan="5" style="text-align: left;vertical-align: text-top"><strong>Dengan rincian gaji sebagai berikut:</strong></td>
                            </tr>
                            <tr>
                                <td style="text-align: left; width:130px ;vertical-align: text-top">Gaji Pokok</td>
                                <td style="width:5px; text-align: left">:</td>
                            ...
                            <tr>
                                ...
                                <td style="text-align:left">Rp.</td>
                                <td style="text-align: right">{{ number_format(Crypt::decryptString($detail->makan)) }}</td>
                                <td style="text-align: left">/ 22 hari</td>
                            </tr>
                            <tr>
                                <td style="text-align: left;vertical-align: text-top">Tunjangan Transport</td>
                                <td style="text-align:left">:</td>
            ...
            <table>
                <tbody>
                    <tr>
                        <table>
                            <tr>
                                <td style="text-align: left; width:130px ;vertical-align: text-top"><strong>Total Gaji Diterima</strong></td>
                                <td style="width:5px; text-align: left">:</td>
                                <td style="width:10px; text-align:left"><strong>Rp.</strong></td>
                                <td style="text-align: right;width:60px"><strong>{{ number_format(Crypt::decryptString($detail->jabatan) + Crypt::decryptString($detail->gapok) + Crypt::decryptString($detail->kinerja) + Crypt::decryptString($detail->pulsa) + Crypt::decryptString($detail->makan) + Crypt::decryptString($detail->transport)) }}</strong></td>
                                <td style="text-align: left"><strong>/ bulan<strong></td>
                            </tr>
                            <tr>
                        </table>
            ...
            <table style="margin-top:15px">   
                <tr>
                    <table  style="margin-top:15px">
                        <tr>
                            <td style="text-align: left;width:10px;vertical-align: text-top">1.</td>
                            <td style="text-align: left">
                                <p style="text-align: justify;vertical-align: text-top">
                                    Hari kerja adalah hari Senin sampai dengan hari Jumat, dan hari Sabtu - Minggu libur sebagaimana mestinya.
                                </p>
                            </td>
                        </tr>
                        <tr>
                            ...
                            <td style="text-align: left">
                                <p style="text-align: justify;vertical-align: text-top">
                                    Jam kerja untuk hari Senin - Jumat adalah 08.00 - 17.00 WIB dengan jam istirahat pada pukul 12.00 - 13.00 WIB, kecuali hari Jumat, jam istirahat pada pukul 11.30 - 13.00 WIB.
                                </p>
                            </td>
                        </tr>
                        <tr>
                            ...
                            <td style="text-align: left">
                                <p style="text-align: justify;vertical-align: text-top">
                                    Apabila diperlukan, Saudara harus bersedia untuk melakukan perjalanan dinas serta bekerja lembur, kecuali dengan alasan yang wajar untuk tidak melakukan hal tersebut.
                                </p>
                            </td>
                        </tr>
                        <tr>
                            ...
                            <td style="text-align: left">
                                <p style="text-align: justify;vertical-align: text-top">
                                    Gaji dibayarkan bulanan dan ditransfer melalui nomor rekening Bank BRI Saudara, untuk periode, tanggal 16 bulan yang lalu sampai dengan dengan tanggal 15 bulan berjalan, dibayarkan pada tanggal 25 atau 26 bulan bejalan dan demikian seterusnya.
                                </p>
                            </td>
                        </tr>
                        <tr>
                            ...
                            <td style="text-align: left">
                                <p style="text-align: justify;vertical-align: text-top">
                                    Surat perincian gaji ini berlaku efektif sejak tanggal {{ $detail->awalkontrakhari .' '. $detail->awalkontrakbulan .' '. $detail->awalkontraktahun }}.
                                </p>
                            </td>
                        </tr>
                    </table>
                ...
                <table>
                    <tbody>
                        ...
                        <tr>
                            <td colspan="4">
                                <p style="text-align: justify">
                                    Para pihak dengan ini setuju dan sepakat untuk membuat Perjanjian Kerja Harian Lepas (selanjutnya disebut “Perjanjian Kerja”) dengan ketentuan dan syarat sebagai berikut:
                                </p>
                            </td>
                        </tr>
                    </tbody>
                ...
                <table style="width: 780px">
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>
                                <p style="text-align: justify">
                                    Hubungan kerja sebagaimana disebutkan diatas dengan sendirinya berakhir pada saat Perjanjian Kerja ini berakhir atau pekerjaan yang telah dikerjakan sudah selesai 100% dan tidak ada tahap selanjutnya, kecuali apabila disepakati secara tertulis oleh para pihak bahwa Perjanjian Kerja ini diperpanjang kembali.
                                </p>
                            </td>
                        </tr>
                        <tr>
                ...
                <table  style="width: 800px;margin-top:50px">
                    <tbody>
                        <tr>
                            ...
                            <td>
                                <p style="text-align: justify">
                                    Atas penempatan Pihak Kedua sebagaimana disebutkan diatas, Pihak Kedua berhak untuk mendapatkan kompensasi dari Pihak Pertama sebesar Rp. 100.000-,- per hari.
                                </p>
                            </td>
                        </tr>
                        <tr>
                            ...
                            <td>
                                <p style="text-align: justify">
                                    Pihak Kedua bersedia melakukan kerja lembur apabila dibutuhkan oleh Pihak Pertama dengan upah lembur Rp. 8.000,- per jam.
                                </p>
                            </td>
                        </tr>
                    </tbody>
