                ...
                <div class="col-12">        
                    <div class="card">
                            ...
                            <div class="card">
                                ...
                                <div class="card-body"> 
                                    ...
                                    <div style="display: flex; justify-content: flex-end">
                                        <a type="button" style="margin: 5pt;width:100px" class="btn btn-success" href="{{ route('editor.careeredit', ['id' => $item->id]) }}">
                                            Ubah
                                        </a>  
                        ...
                        <div class="card-body"> 
                            <div class="card">
                                <div class="mb-3">
                                    <a href="{{ route('editor.careercreate', ['id' => $id]) }}" type="submit" class="btn btn-primary btn-block">Tambah</a>
                                </div>
                            </div>
                        </div>
                    </div>
