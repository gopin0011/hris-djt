                ...
                <div class="col-12">           
                    <div class="card">
                        <div class="card-header">
                            <h3 class="card-title"><strong>Daftar Data Karyawan</strong></h3>
                            <a href="{{ route('employees.index') }}" class="btn btn-warning btn-sm" style="float: right;width: 120px;margin:5px">
                                All ({{ $acount }})
                            </a> 
                            <a href="{{ route('employees.staffalper') }}" class="btn btn-success btn-sm" style="float: right;width: 120px;margin:5px">
                                Alat Peraga ({{ $bcount }})
                            </a>  
                            <a href="{{ route('employees.stafflegano') }}" class="btn btn-primary btn-sm" style="float: right;width: 120px;margin:5px">
                                Legano ({{ $ccount }})
                            </a> 
                        </div>
