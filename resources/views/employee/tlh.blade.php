                ...
                <div class="col-12">           
                    <div class="card">
                        <div class="card-header">
                            <h3 class="card-title"><strong>Daftar Data Karyawan TLH</strong></h3>
                            <a href="{{ route('employees.index-tlh') }}" class="btn btn-warning btn-sm" style="float: right;width: 120px;margin:5px">
                                All ({{ $acount }})
                            </a> 
                            <a href="{{ route('employees.tlhalper') }}" class="btn btn-success btn-sm" style="float: right;width: 120px;margin:5px">
                                Alat Peraga ({{ $bcount }})
                            </a>  
                            <a href="{{ route('employees.tlhlegano') }}" class="btn btn-primary btn-sm" style="float: right;width: 120px;margin:5px">
                                Legano ({{ $ccount }})
                            </a> 
                        </div>
				    ...
				    @endif
				      	...
				      	@endif
                                        <td style="text-align: center">   
                                            <a href="{{ route('salaries.create', ['id' => $item->id]) }}" class="btn btn-primary btn-sm" data-toggle="tooltip" title="Perpanjangan Kontrak" style="width:35px">
