                    ...
                    <div class="card">
                        ...
                        <div class="card-body"> 
                            <div class="card">
                                ...
                                <form method="POST" action="{{ route('families.updatedad', ['id' => Auth::user()->id]) }}">
                                    @csrf 
                                ...
                                @if($ayah != NULL)
                                <form method="POST" action="{{ route('families.updatemom', ['id' => Auth::user()->id]) }}">
                                    @csrf 
                                    <table class="table table-bordered table-striped table-responsive w-100 d-block d-md-table">
                                        <tr>
                                ...
                                @foreach ($mate as $item)
                                    @if($ibu != NULL && Crypt::decryptString($item->status) == 'Menikah')            
                                        <form method="POST" action="{{ route('families.updatemate', ['id' => Auth::user()->id]) }}">
                                            @csrf 
                                            <table class="table table-bordered table-striped table-responsive w-100 d-block d-md-table">
                                                <tr>
                        ...
                        <div class="card-body"> 
                            <div class="card">
                                ...
                                <form method="POST" action="{{ route('families.update', ['id' => Auth::user()->id]) }}">
                                    @csrf 
                                    <table class="table table-bordered table-striped table-responsive w-100 d-block d-md-table">
                                        <thead>
                                        <tr>
                                    ...
                                    <div class="card-body"> 
                                        <a href="{{ route('profiles.index') }}" class="btn btn-secondary btn-sm" style="float:left;width:100px">
                                            Kembali
                                        </a>
                                        @if(($ayah != NULL)&&($ibu != NULL))
                                            <a href="{{ route('careers.index') }}" class="btn btn-primary btn-sm" style="float:right;width:100px">
                                                Lanjutkan
                                            </a>
                                        @endif
                                    </div>
