  ...
  <div class="wrapper">
    ...
    <aside class="main-sidebar sidebar-dark-primary elevation-4">
      ...
      @if(Auth::user()->admin == 0)
        @include('style.sideuser')
      @elseif(Auth::user()->admin == 1 ||Auth::user()->admin == 11)
        @include('style.sideinterviewer')
      @elseif(Auth::user()->admin == 2)
        @include('style.sidestaff')
      @elseif(Auth::user()->admin == 3)
        @include('style.sideadmin')
      @elseif(Auth::user()->admin == 8 || Auth::user()->admin == 9)
        @include('style.sidediv')
      @endif
      <!-- /.sidebar -->
    </aside>
    <!-- Content-->
