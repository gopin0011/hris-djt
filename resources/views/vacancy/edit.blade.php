...
<div class="content-wrapper">
    <section class="content" style="padding-top:15px">
        <div class="container-fluid">
            <div class="row">
                <div class="col-12">
                    <form method="POST" action="{{ route('vacancies.update', ['id' => $data->id]) }}">
                        @csrf      
                        ...
                        <div class="card">
                            ...
                            <div class="card-body"> 
                                <div class="input-group mb-3">
                                    ...
                                    <input type="text" class="form-control" placeholder="Nama lowongan" id="nama" name="nama" value="{{ $data->nama }}">
                                </div>
                                ...
                                <div class="input-group mb-3">
                                    ...
                                    <select class="form-control" id="unit" name="unit">
                                        @foreach ($unit as $item)
                                            <option value="{{ $item->nama }}" {{ $data->unit == $item->nama ? 'selected="selected"' : '' }}>{{ $item->nama }}</option>
                                        @endforeach
                                    </select>
                                </div>
                                ...
                                <div class="input-group mb-3">
                                    ...
                                    <textarea class="form-control" placeholder="Deskripsi pekerjaan" id="deskripsi" name="deskripsi">{{ $data->deskripsi }}</textarea>
                                </div>
